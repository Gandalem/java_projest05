...
public class initinal_value {

	public static void main(String[] args) {
//		기본 자료형과 참조 자료형의 초기값
//		기본 자료형 : stack 공간에 변수와 변수의 값이 저장됨
// 		참조 자료형 (배열): 	stack 공간에 [배열] 변수롸 heap영역의 주소정보가 저장
//						heap영역에는 값이 저장
//				강제 초기화됨. boolean (false), 정수(0), 실수 (0.0)
		
//		1. stack메모리값 (강제 초기화되지 않음)
		int value1;
//		System.out.println(value1); //오류 발생: 초기값이 없다.
		int[] value2;
//		System.out.println(value2); //오류 발생 : value2에 Heap영역의 주소값이 없다.
		int value3= 0;
		System.out.println(value3);
		
		int[] value4 =null; // null : 비어있는 상태, 기본자료형에는 사용할수 없다.
							// 참조자료형에서만 사용가능
		...
		//2. heap영역은 강제 초기화가된다. boolean(false), 정수(0), 실수(0.0)
		//2-1. 기본자료형 배열
		
		boolean[] arr1 = new boolean[3]; // 기본값으로 false가 각방에 할당됨
		for(int i =0;i<arr1.length;i++) {
			System.out.print(arr1[i]+" ");
		} //각방에 초기값이 들어있다.
		System.out.println();
		System.out.println("====정수형 : 초기값 : 0===");
		...
		System.out.println("===문자열 : 초기값 : null===");
 		...
 		System.out.println();
 		System.out.println("===Arrays_toString() 로 출력===");
