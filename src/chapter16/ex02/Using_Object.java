...
//모든 객체는 Object 타입으로 모두 타입변환 할수 있다.
//	Object 타입을 ㅗ지정됨 객체를 가져와서 사용하기 위해서는 매번 다운 캐스팅이 필요하다.
//	모든 객체는 Object타입으로 저장할수있고,
//		매번다운 캐스팅이 필요하다
...
//		2.Goods를 사용해서 Pencil객체를 저장후 가져오기
...
//		3.Goods를 사용해서 Banana객체를 저장후 가져오기
		goods1.setObject(new Banana());
		
		Banana banana1 = (Banana) goods1.getObject();
		System.out.println(banana1.banana);
